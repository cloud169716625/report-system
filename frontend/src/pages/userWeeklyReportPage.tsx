...
import { useGetUserWeeklyReportsQuery } from "../redux/api/reportApi";
...
const UserWeeklyReportPage = () => {
  ...
  const emptyRows =
    page > 0
      ? Math.max(0, (1 + page) * rowsPerPage - userWeeklyReports[0]?.length)
      : 0;

  //Set the times missed to report
  // const missedReport = 5 - userWeeklyReports[0]?.length;
  ...
  return (
    <Container maxWidth={false}>
      ...
      >
        You haven't reported {reportTime} times, this week
      </h5>
      <TableContainer component={Paper} style={{ marginTop: "30px" }}>
        ...
        >
          ...
          <TableBody>
            ...
            {emptyRows > 0 && (
              <TableRow
                style={{ height: 53 * emptyRows, border: "1px solid #ab9c5b" }}
              >
          ...
          <TableFooter>
            <TableRow style={{ border: "1px solid #ab9c5b" }}>
              <TablePagination
                ...
                colSpan={6}
                count={userWeeklyReports[0]?.length}
