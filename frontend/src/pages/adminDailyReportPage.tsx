...
import { useGetDailyReportStatusQuery } from "../redux/api/reportApi";
...
const AdminDailyReportPage = () => {
  ...
  const emptyRows =
    page > 0
      ? Math.max(0, (1 + page) * rowsPerPage - reportsWithUsers[0]?.length)
      : 0;
  ...
  return (
    <Container maxWidth={false}>
      ...
      >
        Today's Roports {"(" + reportsWithUsers[3] + ")"}
      </h5>
      <h5
        style={{
          fontSize: "20px",
      ...
      >
        ...
        haven't reported today {weekend}
      </h5>
