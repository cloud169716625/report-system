...
const UserPaymentPlanPage = () => {
  ...
  const onSubmitHandler: SubmitHandler<ICreatePayPlanFrom> = (values) => {
    ...
    if (submitBoolean) {
      ...
      setError("plan", {
        type: "custom",
        message:
          "Your plan for this period already exists. Please set another period.",
      });
    }
  };
  ...
  return (
    <Container maxWidth={false}>
              ...
              >
                <Paper style={{ boxShadow: "none" }}>
                  <p style={{ margin: "unset", color: "gray" }}>
                    Select the year and month for plan
                  </p>
      ...
      <UserPayPlanTable
        setPlanSubmitAble={(payPlanWhen: any) => setSubmitAble(payPlanWhen)}
      />
    </Container>
  );
};
